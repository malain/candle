...
namespace DSLFactory.Candle.SystemModel.CodeGeneration.CodeModel
{
    ...
    /// 
    /// </summary>
    public class CandleCodeClass : CandleCodeElement
    {
        /// <summary>
        /// 
        /// </summary>
        protected CodeClass _codeElement;
        ...
        {
            return String.Format("[class] {0}", _codeElement.FullName);
        }
    }
}