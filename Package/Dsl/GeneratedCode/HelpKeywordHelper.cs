...
namespace DSLFactory.Candle.SystemModel
{
	...
	/// </remarks>
	public partial class CandleHelpKeywordHelper : CandleHelpKeywordHelperBase 
	{
		
		/// <summary>
		/// Constructs a new CandleHelpKeywordHelper.
		/// </summary>
		protected CandleHelpKeywordHelper()
			: base() { }
			
		/// <summary>
		/// Single instance of the CandleHelpKeywordHelper.
		/// </summary>
		public static CandleHelpKeywordHelper Instance
		{
			get
			{
	...
	/// </summary>
	public abstract class CandleHelpKeywordHelperBase
	{
		private global::System.Collections.Generic.Dictionary<string, string> helpKeywords;
		
		/// <summary>
		/// Constructs a new CandleHelpKeywordHelperBase.
		/// </summary>
		protected CandleHelpKeywordHelperBase()
			: base() { }
