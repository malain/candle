...
namespace DSLFactory.Candle.SystemModel
{
	...
	/// </summary>
	internal partial class CandleCommandSet : CandleCommandSetBase
	{
		/// <summary>
		/// Constructs a new CandleCommandSet.
		/// </summary>
		public CandleCommandSet(global::System.IServiceProvider serviceProvider) 
	...
	/// </summary>
	internal abstract class CandleCommandSetBase : DslShell::CommandSet
	{
		/// <summary>
		/// Constructs a new CandleCommandSetBase.
		/// </summary>
		protected CandleCommandSetBase(global::System.IServiceProvider serviceProvider) : base(serviceProvider)
		{
		}
		...
		protected override global::System.Collections.Generic.IList<global::System.ComponentModel.Design.MenuCommand> GetMenuCommands()
		{
			...
			menuCommand = new DslShell::CommandContextBoundMenuCommand(this.ServiceProvider,
				...
				Constants.ViewCandleExplorerCommand,
		...
		{
			CandleExplorerToolWindow explorer = this.CandleExplorerToolWindow;
			if (explorer != null)
			{
				explorer.Show();
			}
		...
		{
			if (this.CurrentCandleDocData != null && this.CurrentCandleDocData.Store != null)
			{
				this.CurrentCandleDocData.ValidationController.Validate(this.CurrentCandleDocData.Store, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		internal virtual void OnMenuValidate(object sender, global::System.EventArgs e)
		{
			if (this.CurrentCandleDocData != null && this.CurrentCandleDocData.Store != null)
			{
				...
				this.CurrentCandleDocData.ValidationController.Validate(elementList, DslValidation::ValidationCategories.Menu);
			}
		}
		...
		protected CandleDocData CurrentCandleDocData
		{
			get
			{
				return this.MonitorSelection.CurrentDocument as CandleDocData;
			}
		}
		...
		/// </summary>
		[global::System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode")]
		protected CandleDocView CurrentCandleDocView
		{
			get
			{
				return this.MonitorSelection.CurrentDocumentView as CandleDocView;
			}
		}
		...
		/// </summary>
		protected CandleExplorerToolWindow CandleExplorerToolWindow
		{
			get
			{
				CandleExplorerToolWindow explorerWindow = null;
				DslShell::ModelingPackage package = this.ServiceProvider.GetService(typeof(VSShell::Package)) as DslShell::ModelingPackage;

				if (package != null)
				{
					explorerWindow = package.GetToolWindow(typeof(CandleExplorerToolWindow), true) as CandleExplorerToolWindow;
				}
		...
		protected object ExplorerSelection
		{
			get
			{
				...
				CandleExplorerToolWindow explorerWindow = this.CandleExplorerToolWindow;
