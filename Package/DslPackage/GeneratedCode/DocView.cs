...
namespace DSLFactory.Candle.SystemModel
{
	...
	/// </summary>
	internal partial class CandleDocView : CandleDocViewBase
	{
		/// <summary>
		/// Constructs a new CandleDocView.
		/// </summary>
		public CandleDocView(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider)
	...
	/// </summary>
	internal abstract class CandleDocViewBase : DslShell::SingleDiagramDocView
	{
		/// <summary>
		/// Constructs a new CandleDocView.
		/// </summary>
		protected CandleDocViewBase(DslShell::ModelingDocData docData, global::System.IServiceProvider serviceProvider) : base(docData, serviceProvider)
		{
		}
		...
		protected override bool LoadView()
		{
			...
			global::System.Collections.ObjectModel.ReadOnlyCollection<global::DSLFactory.Candle.SystemModel.ComponentModelDiagram> diagrams = this.DocData.Store.ElementDirectory.FindElements<global::DSLFactory.Candle.SystemModel.ComponentModelDiagram>();
			if (diagrams.Count > 0)
			{
		...
		protected override string DefaultToolboxTabName
		{
			get
			{
				return global::DSLFactory.Candle.SystemModel.CandleToolboxHelper.DefaultToolboxTabName;
			}
		}
		...
		protected override int DefaultToolboxTabToolboxItemsCount
		{
			get
			{
				return global::DSLFactory.Candle.SystemModel.CandleToolboxHelper.DefaultToolboxTabToolboxItemsCount;			
			}
		}
		...
		protected override void OnSelectionChanged(global::System.EventArgs e)
		{
			...
			if(global::DSLFactory.Candle.SystemModel.CandleHelpKeywordHelper.Instance != null)
			{
				DslModeling::ModelElement selectedElement = this.PrimarySelection as DslModeling::ModelElement;
				if(selectedElement != null)
				{
					string f1Keyword = global::DSLFactory.Candle.SystemModel.CandleHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
					...
					if(presentationElement != null)
					{
						...
						if(selectedElement != null)
						{
							string modelElementKeyword = global::DSLFactory.Candle.SystemModel.CandleHelpKeywordHelper.Instance.GetHelpKeyword(selectedElement);
